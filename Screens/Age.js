...
import RNDateTimePicker from '@react-native-community/datetimepicker';
   ...
   return (
    <View>
      <View>
  <Text style={{fontSize:30, marginRight:50,marginLeft:50, margin:60, marginBottom:10}}> When were you born? </Text>
  </View>
 <View>
  <Text style={{margin:10, marginLeft:26}}> In order to use Schoolyard you must be 13 years or older, select your birthday below </Text>
  </View>
  <View>
  <RNDateTimePicker
    style={{ alignItems:'center',justifyContent:"center", marginRight:130, paddingLeft:50, margin:70, marginBottom:160}}
    mode="date" 
    value={date}
